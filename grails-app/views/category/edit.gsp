                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="underCategoriesLevel1"><g:message code="category.underCategoriesLevel1.label" default="Under Categories Level1" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: categoryInstance, field: 'underCategoriesLevel1', 'errors')}">
                                    
<ul>
<g:each in="${categoryInstance?.underCategoriesLevel1?}" var="u">
    <li><g:link controller="underCategoryLevel1" action="show" id="${u.id}">${u?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="underCategoryLevel1" action="create" params="['category.id': categoryInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'underCategoryLevel1.label', default: 'UnderCategoryLevel1')])}</g:link>
